...
#define  Moto1_DIR_PIN     GPIO_Pin_1
#define  Moto1_STEP_PORT   GPIOA
#define  Moto1_STEP_PIN    GPIO_Pin_2
#define  Moto1_ZERO_PORT   GPIOB
#define  Moto1_ZERO_PIN    GPIO_Pin_5

#define  Moto2_REF_PORT    GPIOB
#define  Moto2_REF_PIN     GPIO_Pin_0
...
#define  Moto3_REF_PORT   GPIOB
#define  Moto3_REF_PIN    GPIO_Pin_12
...
#define  Moto4_REF_PORT   GPIOB
#define  Moto4_REF_PIN    GPIO_Pin_6
...
typedef struct __midustepctrpra{
  ...
  uint16_t   MotoRunHzMax;      //马达运行最高频率，单位HZ
  uint16_t   MotoRunHzMin;       //马达运行最低频率，启动频率，单位HZ
  uint16_t   MotoRunHzDangqian; //马达运行当前频率， 单位HZ
  uint32_t   MotoRunCmpValue;   //中断比较 值
  int16_t    MotoDumuPuls;      //需要运行的脉冲数
